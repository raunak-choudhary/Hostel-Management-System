...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time,sender_name) VALUES ('$roll','$hos_man_user','$hostel_id','$subject','$message','$today_date','$time','$sname')";
