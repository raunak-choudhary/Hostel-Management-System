			...
			<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="dropdown nav-item">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Login as
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu agile_short_dropdown">
							...
							<li>
								<a href="login-hostel_manager.php">Hostel Manager</a>
							</li>
							<li>
								<a href="login-hostel_manager.php">Admin</a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/smvitm.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='914px' width="1600px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/boyshostel.png"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='914px' width="1600px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/girlshostel1.png"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
