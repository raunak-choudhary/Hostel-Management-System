...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="includes/login-hm.inc.php" method="POST">
          ...
          <p class=" w3l-register-p">Login as<a href="student-login.php" class="register"> Student</a></p>
        <p class=" w3l-register-p">Don't have an account?<a href="signup-admin.php" class="register">Sign up</a></p>
    </div>
    <footer>
