				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active">
							<a class="nav-link" href="create_hm.php">Appoint/Remove Hostel Manager<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
	...
	<div class="main">
		...
		<div id="wrapper" class="w3ls_wrapper w3layouts_wrapper">
			<div id="steps" style="margin:0 auto;" class="agileits w3_steps">
				<form id="formElem" name="formElem" action="../includes/hm_signup.inc.php" method="post" class="w3_form w3l_form_fancy">
            ...
            <div class="agilecontactw3ls-grid">
              <div class="agile-con-centre">
                <form action="../includes/hm_signup.php" method="POST">
				  <input type="text" name="hm_id" placeholder="HOSTEL MANAGER ID" required="required">
                  ...
                  <input type="text" name="hostel_id" placeholder="HOSTEL ID" required="required">
              ...
              <div class="clear"></div>
				...
				<form id="formElem" name="formElem" action="../includes/hm_remove.inc.php" method="post" class="w3_form w3l_form_fancy">
				<fieldset class="step w3_agileits">
